...
<head>
    ...
    <link rel="stylesheet" href="/assets/blog/buttoncreative.agency/html/shareen/fonts/elegant-font/style.css">
    ...
    <link rel="stylesheet" href="/assets/blog/buttoncreative.agency/html/shareen/fonts/font-awesome/css/font-awesome.min.css">

    <link rel="stylesheet" href="/assets/blog/buttoncreative.agency/html/shareen/styles/bootstrap.css" />
    <link rel="stylesheet" href="/assets/blog/buttoncreative.agency/html/shareen/styles/main.css" />
</head>
<body>
      ...
      <div class="container expanded">
        <div class="owl-big-banner owl-carousel">
          <div class="item">
            ...
            <img src="images/big-banner-01.jpg" alt="">
          ...
          <div class="item">
            <div class="overlay"></div>
            <img src="images/big-banner-02.jpg" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>Lifestyle</span>
          ...
          <div class="item">
            <div class="overlay"></div>
            <img src="images/big-banner-03.jpg" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>Beauty</span>
          ...
          <div class="item">
            <div class="overlay"></div>
            <img src="images/big-banner-04.jpg" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>Nature</span>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="standard-posts">
              <div class="row">
				<?php 
					include('/output_articles.php');
				?>
				
                <div class="col-lg-12">
                  <div class="standard-post">
                    <div class="post-image">
                      <a href="single-standard-post.html"><img src="images/standard-post-image-01.jpg" alt=""></a>
                    </div>
                ...
                <div class="col-lg-12">
                  <div class="standard-post">
                    <div class="post-image">
                      <a href="single-standard-post.html"><img src="images/standard-post-image-02.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="meta-category">
                        <span>Fashion</span>
                ...
                <div class="col-lg-12">
                  <div class="standard-post">
                    <div class="post-image">
                      <a href="single-standard-post.html"><img src="images/standard-post-image-03.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="meta-category">
                        <span>Beauty</span>
                ...
                <div class="col-lg-12">
                  <div class="widget-sidebar about-me">
                    ...
                    <div class="widget-content">
                      <img src="images/about-me-sidebar.jpg" alt="">
                  ...
                  <div class="widget-sidebar promo-post">
                    ...
                    <div class="widget-content">
                      <div class="promo-image">
                        <img src="images/promo-image-sidebar.jpg" alt="">
                  ...
                  <div class="widget-sidebar instagram-posts">
                    ...
                    <div class="widget-content">
                      <div class="instagram-item left-item first-row">
                        <img src="images/instagram-sidebar-01.jpg" alt="">
                      </div>
                      <div class="instagram-item first-row">
                        <img src="images/instagram-sidebar-02.jpg" alt="">
                      </div>
                      <div class="instagram-item left-item">
                        <img src="images/instagram-sidebar-03.jpg" alt="">
                      </div>
                      <div class="instagram-item">
                        <img src="images/instagram-sidebar-04.jpg" alt="">
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="widget-content">
                      <ul class="latest-post-list">
                        <li>
                          <a href="single-standard-post.html">
                            <div class="left-image">
                              <img src="images/latest-post-sidebar-01.jpg" alt="">
                              <span>9</span>
                            </div>
                        ...
                        <li>
                          <a href="single-standard-post.html">
                            <div class="left-image">
                              <img src="images/latest-post-sidebar-02.jpg" alt="">
                              <span>3</span>
                            </div>
                            <div class="right-content">
                        ...
                        <li>
                          <a href="single-standard-post.html">
                            <div class="left-image">
                              <img src="images/latest-post-sidebar-03.jpg" alt="">
                              <span>7</span>
                            </div>
                            <div class="right-content">
