      ...
      <div class="mobile-menu-inner">
        <ul class="mobile-menu">
          <li class="has-sub"><a href="#">Home <i class="sub-icon fa fa-angle-down"></i></a>
            <ul class="sub-menu">
              <li><a href="index-2.html">Standard Posts</a></li>
    ...
    <section class="above-header">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 align-self-center">
            <div class="logo">
              <a href="assets/index-2.html"><img src="assets/images/logo.png" alt=""></a>
            </div>
          </div>
          <div class="col-lg-4 align-self-center">
          ...
          <div class="header-nav">
              <ul class="main-menu">
                <li class="menu-item-has-children active"><a href="#">Home</a>
                  <ul class="sub-menu">
                    <li><a href="assets/index-2.html">Standard Posts</a></li>
                    <li><a href="assets/home-recent.html">Recent Posts</a></li>
                    <li><a href="assets/home-masonry.html">Masonry Posts</a></li>
                    <li><a href="assets/home-list.html">List Posts</a></li>
                    <li><a href="assets/home-full-width.html">Full Width Posts</a></li>
                    <li><a href="assets/home-without-sidebar.html">Without Sidebar</a></li>
                  </ul>
                </li>
                <li class="menu-item-has-children"><a href="#">Sliders</a>
                  <ul class="sub-menu">
                    <li><a href="assets/slider-boxed.html">Boxed Slider</a></li>
                    <li><a href="assets/slider-full-width.html">Full Width Slider</a></li>
                    <li><a href="assets/slider-medium.html">Two Big Posts</a></li>
                    <li><a href="assets/slider-small.html">Three Big Posts</a></li>
                    <li><a href="assets/slider-infinity.html">Infinity Scroll</a></li>
                  </ul>
                </li>
                <li><a href="pages-about-me-v1.html">About</a></li>
                <li class="menu-item-has-children"><a href="#">Pages</a>
                  <ul class="sub-menu">
                    <li><a href="assets/pages-left-sidebar.html">Left Sidebar</a></li>
                    <li><a href="assets/pages-right-sidebar.html">Right Sidebar</a></li>
                    <li><a href="assets/pages-without-sidebar.html">Without Sidebar</a></li>
                    <li><a href="assets/pages-about-me-v1.html">About Version 1</a></li>
                    <li><a href="assets/pages-about-me-v2.html">About Version 2</a></li>
                    <li><a href="assets/pages-contact-me-v1.html">Contact Version 1</a></li>
                    <li><a href="assets/pages-contact-me-v2.html">Contact Version 2</a></li>
                    <li><a href="assets/pages-error-404.html">Error Page 404</a></li>
                    <li><a href="assets/pages-coming-soon.html">Coming Soon Page</a></li>
                  </ul>
                </li>
                <li class="menu-item-has-children"><a href="#">Posts</a>
                  <ul class="sub-menu">
                    <li><a href="assets/single-standard-post.html">Standard Post</a></li>
                    <li><a href="assets/single-audio-post.html">Audio Post</a></li>
                    <li><a href="assets/single-video-post.html">Video Post</a></li>
                    <li><a href="assets/single-gallery-post.html">Gallery Post</a></li>
                    <li><a href="assets/single-quote-post.html">Quote Post</a></li>
                    <li><a href="assets/single-post-left-sidebar.html">Left Sidebar Post</a></li>
                    <li><a href="assets/single-post-right-sidebar.html">Right Sidebar Post</a></li>
                    <li><a href="assets/single-post-without-sidebar.html">Without Sidebar Post</a></li>
                  </ul>
                </li>
                <li><a href="assets/pages-contact-me-v2.html">Contact</a></li>
              </ul>
          </div>
